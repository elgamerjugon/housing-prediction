...
def generate_model():
    ...
    log_transformer = FeatureEngineer(columns=to_log_cols)
    ...
    preprocessor = ColumnTransformer(transformers=[
        ("log", log_transformer, to_log_cols),
    ...
    pipeline = Pipeline([
        ("preprocessor", preprocessor),
        ("model", RandomForestRegressor(max_depth=40, max_features='sqrt', min_samples_split=5))
    ])
